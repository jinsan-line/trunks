...
import (
	...
	"github.com/straightdave/trunks/lib/lttb"
)
...
func (ls *labeledSeries) add(r *trunks.Result) (err error) {
	label := ls.label(r)
...
func (p *Plot) Add(r *trunks.Result) error {
